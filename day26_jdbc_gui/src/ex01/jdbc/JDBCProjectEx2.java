...
public class JDBCProjectEx2 extends JFrame implements ActionListener {
	...
	public JDBCProjectEx2(){  // 생성자함수 - 멤버변수 초기화 담당
		setTitle("고객 정보 입력 폼");
		//component 등록
	...
	private void init() {  //초기화 메소드
		...
		txtEmail.setText("kosa@sw.or.kr");			txtEmail.setEditable(false);
		txtPhone.setText("111-2222-3333");		txtPhone.setEditable(false);
	}// init() end
